...
import AutoGPT from "../public/images/community/AutoGPT.svg";
...
export const community: CommunityProps[] = [
  ...
  },
  {
    ...
    type: "protocol",
    color:
      "radial-gradient(circle at 0% 40%, #52e5ff 10%, #5157ff 70%, #0e183d 90%)",
    position: {
      x: 81,
      y: 45,
      r: [
        "calc(var(--vmin, 1vmin) * 8)",
        "calc(var(--vmin, 1vmin) * 8)",
        "calc(var(--vmin, 1vmin) * 8)",
        "calc(var(--vmin, 1vmin) * 14)",
      ],
      rot: -28,
    },
  },
  {
    ...
    type: "protocol",
    color:
      "radial-gradient(circle at 20% 100%, #a4fcf5, #82a9f9 30%, #3025af 80%)",
    position: {
      x: 60,
      y: 18,
      r: [
        "calc(var(--vmin, 1vmin) * 11)",
        "calc(var(--vmin, 1vmin) * 11)",
        "calc(var(--vmin, 1vmin) * 11)",
        "calc(var(--vmin, 1vmin) * 17)",
      ],
      rot: -12,
    },
  },
  {
    ...
    type: "protocol",
    color:
      "radial-gradient(circle at 0% 80%, #f5c3a6 20%, #b45f63, #191919 95%)",
    position: {
      x: 73,
      y: 32,
      r: [
        "calc(var(--vmin, 1vmin) * 7)",
        "calc(var(--vmin, 1vmin) * 7)",
        "calc(var(--vmin, 1vmin) * 7)",
        "calc(var(--vmin, 1vmin) * 11)",
      ],
  ...
  },
  {
    ...
    type: "protocol",
    color:
      "radial-gradient(circle at 82% 100%, #64c3ca 15%, #266a6f 40%, #041828 90%)",
    position: {
      x: 39,
      y: 27,
      r: [
        "calc(var(--vmin, 1vmin) * 9)",
        "calc(var(--vmin, 1vmin) * 9)",
        "calc(var(--vmin, 1vmin) * 9)",
        "calc(var(--vmin, 1vmin) * 13)",
      ],
      rot: 4,
    },
  },
  {
    ...
    type: "protocol",
    color:
      "radial-gradient(circle at 100% 30%, #dca656 20%, #dc5656, #02042f 90%)",
    position: {
      x: 25,
      y: 75,
      r: [
  ...
  },
  {
    ...
    type: "protocol",
    color:
      "radial-gradient(circle at 62% 0%, #c5ec4b 2%, #1c8aed 40%, #0e346c 70%, #111f2e 90%)",
    position: {
      x: 40,
      y: 78,
      r: [
        "calc(var(--vmin, 1vmin) * 6)",
        "calc(var(--vmin, 1vmin) * 6)",
        "calc(var(--vmin, 1vmin) * 6)",
        "calc(var(--vmin, 1vmin) * 10)",
      ],
      rot: 18,
    },
  },
  {
    ...
    type: "protocol",
    color:
      "radial-gradient(circle at 40% 0%, #e5047a 5%, #af258b 50%, #1e1e1e 90%)",
    position: {
      x: 66,
      y: 56,
      r: [
  ...
  },
  {
    ...
    type: "protocol",
    color:
      "radial-gradient(circle at 90% 50%, #ff007a, #991a6d 70%, #243183 95%)",
    position: {
      x: 26,
      y: 54,
      r: [
